...
defineFeature(feature, (test) => {
  ...
  test.skip("AC1. PUT: Attempt to update a new vehicle without a mandatory field", ({given, when, then}) => {
  ...
  test.skip("AC2. PUT: Attempt to update a new vehicle with a not applicable field", ({given, when, then}) => {
    let requestUrl: string;
    let response: any;
  ...
  test.skip("AC3. PUT: Attempt to update a new vehicle with unexpected values for a field that accepts only specific values", ({given, when, then}) => {
    let requestUrl: string;
    let response: any;
  ...
  test.skip("AC4. PUT: Attempt to update a new vehicle, using a field which has a field value outside of the min/max length for that field", ({given, when, then}) => {
    let requestUrl: string;
    let response: any;
