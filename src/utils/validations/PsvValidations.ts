...
export const psvValidation = commonSchema.keys({
  ...
  brakes: brakesSchema.keys({
    ...
    retarderBrakeOne: Joi.string()
      .valid(...RETARDER_BRAKE)
      .optional()
      .allow(null, ""),
    retarderBrakeTwo: Joi.string()
      .valid(...RETARDER_BRAKE)
      .optional()
      .allow(null, ""),
  ...
  dda: Joi.object()
    .keys({
      ...
      wheelchairLiftInformation: Joi.string()
        .max(250)
        .optional()
        .allow(null, ""),
      wheelchairRampPresent: Joi.boolean().optional().allow(null, ""),
      wheelchairRampInformation: Joi.string()
        .max(250)
        .optional()
        .allow(null, ""),
  ...
  axles: Joi.array().items(
    axlesSchema.keys({
      ...
      tyres: tyresSchema.keys({
        speedCategorySymbol: Joi.string()
          .valid(...SPEED_CATEGORY_SYMBOL)
          .allow(null, ""),
      }),
    })
  ),
  ...
  fuelPropulsionSystem: Joi.string()
    ...
    .allow(null, ""),
  numberOfWheelsDriven: Joi.number()
    .min(0)
    .max(9999)
    .optional()
    .allow(null)
    .allow(null, ""),
  emissionsLimit: Joi.number()
    .min(0)
    .max(99)
    .optional()
    .allow(null)
    .allow(null, ""),
  trainDesignWeight: Joi.number()
    .min(0)
    .max(99999)
    .optional()
    .allow(null)
  ...
  seatbeltInstallationApprovalDate: Joi.string()
    .optional()
    .allow(null, "")
    .allow(null, ""),
  coifSerialNumber: Joi.string()
    .max(8)
    .optional()
    .allow(null, "")
    .allow(null, ""),
  coifCertifierName: Joi.string()
    .max(20)
    .optional()
    .allow(null, "")
    .allow(null, ""),
  ...
  dimensions: Joi.object()
    ...
    .optional()
    .allow(null, ""),
  frontAxleToRearAxle: Joi.number()
    .min(0)
    .max(99999)
    .optional()
    .allow(null, ""),
